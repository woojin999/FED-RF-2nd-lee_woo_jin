...
window.addEventListener("DOMContentLoaded", () => {
  ...
  for (let i = 0; i < 20; i++) {
    // console.log(i);
    ibxWrap.innerHTML += `<div class="ln" style="top:${100 * (i + 1)}px">${
      100 * (i + 1)
    }px</div>`;
  }
  ...
  for (let i = 0; i < 9; i++) {
    // console.log(i);
    ibxWrap.innerHTML += `<div class="ln2" style="left:${100 * (i + 1)}px">${
      100 * (i + 1)
    }px</div>`;
  }
  ...
  for (let i = 0; i < 25; i++) {
    // console.log(i);
    bd.innerHTML += `<div class="ln" style="top:${100 * (i + 1)}px">${
      100 * (i + 1)
    }px</div>`;
  }
  ...
  for (let i = 0; i < 25; i++) {
    // console.log(i);
    bd.innerHTML += `<div class="ln2" style="left:${100 * (i + 1)}px">${
      100 * (i + 1)
    }px</div>`;
  }
  ...
  setInterval(function () {
    ...
    qs(".i31").innerText = (
      bird.getBoundingClientRect().top + window.scrollY
    ).toFixed(0);
