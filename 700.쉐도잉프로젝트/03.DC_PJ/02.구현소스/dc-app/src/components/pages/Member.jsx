...
function Member() {
  ...
  const changeUserId = (e) => {
    ...
    if (valid.test(val)) {
      ...
      // -> 배열데이터로 변환
      // 주의: JSON 파싱할 때 원본형식이 제이슨 파일형식으로
      // 엄격하게 작성되어야 에러가 없음(마지막 콤마 불허용등)
      ...
      // 비교참고 -> every() 는 모두 true이면 true 처리(하나라도 false면 false 리턴)
      //   let isT = memData.some((v) => {
      //     console.log("ㄷㅇ",v.uid);
      //     return v.uid == val;
      //   });
