...
/* 
    ...
    <React.Fragment></React.Fragment> 를 사용하면 내보낼때 하나로 묶는 역할만 하고 실제로 태그는 출력안됨
    (참고:CLI환경에서는 빈태그를 대신 사용가능)
*/
...
function MyFirstReact() {
  ...
  return (
    <React.Fragment>
      ...
      <img
        src="https://cdn-images-1.medium.com/max/1028/1*GqKCwu0iDD0h3XRn8OB9Kw.png"
        alt=""
      />
      <h2>
        [ 리액트란 무엇인가? ]
