...
function IronMan() {
  return (
    <React.Fragment>
      <MakeImage desc="나는 아이언맨" isrc="ab1.jpg" ialt="아이언맨" />
...
/************************************************* 
    ...
    -> 컴포넌트에 중괄호를 사용하면 개별적인 속성변수를 전달 받을 수 있다(구조분해할당방식)
...
// 좋아하는 색과 음식, 취미를 각각 속성명으로 컴포넌트를 호출하면 개별적으로 속성을 구분할 수 있다
// 출력: 세번째 .root
ReactDOM.render(<FavoriteThings color="와인색" food="와인" hobby="와인마시기"/>,target[2]);

// 출력: 네번째 .root
ReactDOM.render(<FavoriteThings color="푸르딩딩한색" food="고기" hobby="클라이밍"/>,target[3]);
