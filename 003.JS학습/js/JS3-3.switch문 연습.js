...
/*********************************** 
    1.함수명: changeImg
    2.기능 : 버튼별 스틸컷 변경
    3.원리 : 클릭된 버튼 텍스트를 읽어 구분하여 if문을 작성후 변경할 이미지 경로를 만들어서 실제 이미지 src에 할당하여 이미지를 변경한다
***********************************/
function changeImg() {
...
for (let index = 0; index < btns.length; index++) {
  btns.item(index).onclick = changeImg;
}
