...
// 제이쿼리에서 전체 스크롤/휠 이벤트 작성시 대상은 항상 html,body 로 두개 모두 잡아준다
...
scTarget.on("wheel", (e) => {
  ...
  // (1) event.wheelDelta 값 : 기본이동 100px + 앞뒤예비공백 10px * 2 = 20px
...
//   let delta = event.wheelDelta;
  ...
  // 방향은 양수가 아랫방향
  // -> wheelDelta보다 나중에 나온 실질적은 표시객체임
  let delta = event.deltaY;
  ...
  scTarget.stop().animate({ scrollLeft: scPos + "px" }, 2000, "easeOutQuint");
}); //// wheel 이벤트트 구역 ///
