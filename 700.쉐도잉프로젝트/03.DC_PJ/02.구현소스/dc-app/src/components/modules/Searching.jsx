...
function Searching({ kword }) {
  ...
  const newList = catListData.filter((v) => {
    ...
    if (
      ...
      // 2. 체크박스 항목 조건 (alignment속성)
      // 주의: 조건문 내의 삼항연산자는 반드시 소괄호로 묶어서 논리연산자(&&,||,!)와의 충돌을 막아주어야함
      // or문의 결과가 false이려면 모두 false여야한다
  ...
  // [ 결과내 재검색 : 데이터 항목 중 alignment 값으로 검색함 ]
