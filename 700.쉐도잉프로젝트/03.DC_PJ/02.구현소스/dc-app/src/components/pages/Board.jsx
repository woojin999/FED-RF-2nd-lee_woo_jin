    ...
    <>
      <div className="selbx">
        <select name="cta" id="cta" className="cta">
          ...
          <option defaultValue="cont">Contents</option>
          <option defaultValue="unm">Writer</option>
        </select>
        <select
          name="sel"
          id="sel"
        ...
        >
          <option defaultValue="0" selected={sort == 1 ? true : false}>
            Descending
          </option>
          <option defaultValue="1" selected={sort == -1 ? true : false}>
            Ascending
          </option>
        </select>
        <input
        ...
        <select
          ...
          style={{ float: "right" }}
        >
          <option defaultValue="idx" selected={sortCta == "idx" ? true : false}>
            Recent
          </option>
          <option defaultValue="tit" selected={sortCta == "tit" ? true : false}>
            Title
          </option>
        </select>
      </div>
